...
class CloudTrendAnalysis:
    ...
    def take_reading(self):
        ...
        trend_info = self._detect_local_trends(temp, now)
    ...
    def _detect_local_trends(self, current_temp, current_time):
...
class CloudAdaptiveStatistics:
    ...
    def take_reading(self):
        ...
        self._check_adaptive_thresholds(temp, humidity, now)
    ...
    def _check_adaptive_thresholds(self, temp, humidity, timestamp):
